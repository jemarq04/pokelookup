...
mod tests {
  ...
  async fn test_evolutions() {
    ...
    let success = vec![
      vec![
        ...
        "eevee -> level-up (location: eterna-forest, near_special_rock) -> leafeon",
        "eevee -> level-up (location: pinwheel-forest, near_special_rock) -> leafeon",
        "eevee -> level-up (location: kalos-route-20, near_special_rock) -> leafeon",
        "eevee -> use-item (item: leaf-stone) -> leafeon",
        "eevee -> level-up (location: petalburg-woods, near_special_rock) -> leafeon",
        "eevee -> level-up (location: lush-jungle, near_special_rock) -> leafeon",
        "eevee -> level-up (location: sinnoh-route-217, near_special_rock) -> glaceon",
        "eevee -> level-up (location: twist-mountain, near_special_rock) -> glaceon",
        "eevee -> level-up (location: frost-cavern, near_special_rock) -> glaceon",
        "eevee -> use-item (item: ice-stone) -> glaceon",
        "eevee -> level-up (location: shoal-cave, near_special_rock) -> glaceon",
        "eevee -> level-up (location: mount-lanakila, near_special_rock) -> glaceon",
      ...
      vec![
        ...
        "Eevee -> Level up (location: Eterna Forest, near_special_rock) -> Leafeon",
        "Eevee -> Level up (location: Pinwheel Forest, near_special_rock) -> Leafeon",
        "Eevee -> Level up (location: Route 20, near_special_rock) -> Leafeon",
        "Eevee -> Use item (item: Leaf Stone) -> Leafeon",
        "Eevee -> Level up (location: Petalburg Woods, near_special_rock) -> Leafeon",
        "Eevee -> Level up (location: Lush Jungle, near_special_rock) -> Leafeon",
        "Eevee -> Level up (location: Route 217, near_special_rock) -> Glaceon",
        "Eevee -> Level up (location: Twist Mountain, near_special_rock) -> Glaceon",
        "Eevee -> Level up (location: Frost Cavern, near_special_rock) -> Glaceon",
        "Eevee -> Use item (item: Ice Stone) -> Glaceon",
        "Eevee -> Level up (location: Shoal Cave, near_special_rock) -> Glaceon",
  ...
  async fn test_evolutions_secret() {
    ...
    let success = vec![
      ...
      "MON -> level-up (location: eterna-forest, near_special_rock) -> MON",
      "MON -> level-up (location: pinwheel-forest, near_special_rock) -> MON",
      "MON -> level-up (location: kalos-route-20, near_special_rock) -> MON",
      "MON -> use-item (item: leaf-stone) -> MON",
      "MON -> level-up (location: petalburg-woods, near_special_rock) -> MON",
      "MON -> level-up (location: lush-jungle, near_special_rock) -> MON",
      "MON -> level-up (location: sinnoh-route-217, near_special_rock) -> MON",
      "MON -> level-up (location: twist-mountain, near_special_rock) -> MON",
      "MON -> level-up (location: frost-cavern, near_special_rock) -> MON",
      "MON -> use-item (item: ice-stone) -> MON",
      "MON -> level-up (location: shoal-cave, near_special_rock) -> MON",
      "MON -> level-up (location: mount-lanakila, near_special_rock) -> MON",
  ...
  async fn test_evolutions_language() {
    ...
    let success = vec![
      ...
      "Eevee -> level-up (location: eterna-forest, near_special_rock) -> Leafeon",
      "Eevee -> level-up (location: pinwheel-forest, near_special_rock) -> Leafeon",
      "Eevee -> level-up (location: Ruta 20, near_special_rock) -> Leafeon",
      "Eevee -> use-item (item: Piedra Hoja) -> Leafeon",
      "Eevee -> level-up (location: Bosque Petalia, near_special_rock) -> Leafeon",
      "Eevee -> level-up (location: Jungla Umbría, near_special_rock) -> Leafeon",
      "Eevee -> level-up (location: sinnoh-route-217, near_special_rock) -> Glaceon",
      "Eevee -> level-up (location: twist-mountain, near_special_rock) -> Glaceon",
      "Eevee -> level-up (location: Gruta Helada, near_special_rock) -> Glaceon",
      "Eevee -> use-item (item: Piedra Hielo) -> Glaceon",
      "Eevee -> level-up (location: Cueva Cardumen, near_special_rock) -> Glaceon",
      "Eevee -> level-up (location: Monte Lanakila, near_special_rock) -> Glaceon",
  ...
  async fn test_evolutions_regional_forms() {
    ...
    let success = vec![
      ...
      "Rattata -> Level up (min_level: 20, time_of_day: night, base_form: Alolan Rattata, evolved_form: Alolan Raticate) -> Raticate",
    ];
